...
public class PrimeraClase {
    ...
    public static void main(String[] args) {
         ...
         * "El producto tiene un precio de: "+precio+" y su precio final es de: "+(
         * precio+(precio*IVA)));
         */
        ...
        try (/*
              ...
              * y luego ingrese la longitud de cada perfil sabiendo que la pieza cuya
              * longitud
            ...
            for (int i = 1; i <= N; i++) {
                ...
                System.out.println("La cantidad de piezas actas es: " + P);
            }
        }
